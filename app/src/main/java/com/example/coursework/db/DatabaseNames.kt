...
object DatabaseNames: BaseColumns {
    ...
    const val STUDENT_COLUMN_TEACHER_NAME = "teacher_name"
    ...
    const val CREATE_STUDENT_TABLE = "CREATE TABLE $STUDENT_TABLE_NAME (" +
            ...
            "$STUDENT_COLUMN_AUDIENCE TEXT, $STUDENT_COLUMN_DAY, $STUDENT_COLUMN_TEACHER_NAME TEXT)"
    const val SQL_DELETE_STUDENT_TABLE = "DROP TABLE IF EXISTS $STUDENT_TABLE_NAME"
    ...
    const val SQL_DELETE_SCHOOLKID_TABLE = "DROP TABLE IF EXISTS $SCHOOLKID_TABLE_NAME"
}